...
上升时为阻力（取+），下降时为驱动力（取-），则 :math:`\psi\le\rho'` 时自锁。
...
.. math::
	...
	T=F_a\frac{d_2}{2}\tan(\psi\pm\rho')+f_c F_a r_f\\
	在f_c=f'=0.15条件下,T=0.2F_a d\\
	一般预紧应力\sigma=\frac{F_a}{\pi d_1^2/4}\le 0.5\sim 0.7 \sigma_s

强度
----

核心方程： :math:`\sigma_e\le[\sigma]`
